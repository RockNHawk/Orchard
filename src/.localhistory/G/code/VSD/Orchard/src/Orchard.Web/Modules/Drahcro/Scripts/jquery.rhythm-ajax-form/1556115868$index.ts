...
module RhythmAjaxForm {
    ...
    */
    ...
    function bindFormAjax($: JQueryStatic, form: HTMLFormElement, options: AjaxFormOptions, history: History) {
       ...
       var $ajaxInputs = $("<input value='XMLHttpRequest' name='X-Requested-With' type='hidden' /><input value='RhythmAjaxForm' name='X-Requested-With-Rhythm-Ajax-Form' type='hidden' />");
