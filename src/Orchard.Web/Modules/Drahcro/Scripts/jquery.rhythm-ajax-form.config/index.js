...
; (function ($) {
    ...
    var bindFormAsAjax = (function (form) {
        var $form = $(form || this);
        //alert($form.length);
    ...
    (function () {
        ...
        $(".rhythm-form-button,[rhythm-form-button]").livequery(function () {
            ...
            $btn.click(function () {
                ...
                $btn.addClass("ajax-button-progress");
                if (btnName) {
                    var $namedInput = $form.find(String.format(":input[name='{0}']", btnName)).not("button[type!='submit']");
                    if ($namedInput.length) {
                        ...
                        $namedInput = $(String.format("<button type='submit' style='display:none;' name='{0}' value='{1}' ></button>", btnName, btnValue));
