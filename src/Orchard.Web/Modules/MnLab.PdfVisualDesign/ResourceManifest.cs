...
namespace MnLab.PdfVisualDesign.HtmlBlocks
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(ResourceManifestBuilder builder)
        {
            ...
            manifest.DefineStyle("HB_CodeMirror").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/codemirror/lib/codemirror.css");
            manifest.DefineStyle("HB_CodeMirror_Lint").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/codemirror/addon/lint/lint.css").SetDependencies("HB_CodeMirror");
            manifest.DefineStyle("HB_CodeMirror_MatchScrollbar").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/codemirror/addon/search/matchesonscrollbar.css").SetDependencies("HB_CodeMirror");
            manifest.DefineStyle("HB_CodeMirror_Dialog").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/codemirror/addon/dialog/dialog.css").SetDependencies("HB_CodeMirror");

            manifest.DefineScript("HB_Highlightjs").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/highlightjs/highlight.pack.js");
            manifest.DefineStyle("HB_Highlightjs").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/highlightjs/styles/vs.css");
            manifest.DefineScript("HB_Highlightjs_Init").SetUrl("~/modules/MnLab.PdfVisualDesign.HtmlBlocks/Scripts/HighlightjsInit.js").SetDependencies("HB_Highlightjs");
        }
    }
}