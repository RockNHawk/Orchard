...
*/
    ...
    HandsontableCustomHelper.prototype.onTableValueChange = function (changes, newData, isDesignMode) {
     ...
     * @param newData
     */
    HandsontableCustomHelper.prototype.fixNewData = function (changes, newData, oldData, isDesignMode) {
        if (newData) {
            // debugger
